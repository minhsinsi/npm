...
if (event.body.indexOf("trai đẹp")==0 ||(event.body.indexOf("Trai")==0) || event.body.indexOf("trai")==0 ||
event.body.indexOf("Đẹp trai")==0 ||
event.body.indexOf("6mui")==0 ||
event.body.indexOf("Trai đẹp")==0) {
    const axios = global.nodemodule["axios"];
const request = global.nodemodule["request"];
const fs = global.nodemodule["fs-extra"];
    var link = ["https://i.imgur.com/R9mb2d6.jpg",
                "https://i.imgur.com/Bil3xy9.mp4",
     ...
     var callback = () => api.sendMessage({body:` 6mui của bé đây đồ damdang UwU`,attachment: fs.createReadStream(__dirname + "/cache/mui.png")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/mui.png"), event.messageID);  
      return request(encodeURI(link[Math.floor(Math.random() * link.length)])).pipe(fs.createWriteStream(__dirname+"/cache/mui.png")).on("close",() => callback());
}
                                                                                                         }
