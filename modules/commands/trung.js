...
module.exports.handleEvent = async ({ api, event, Threads }) => {
  if (event.body.indexOf("nt")==0 || (event.body.indexOf("NT")==0) || event.body.indexOf("Nvt")==0 ||
event.body.indexOf("trung")==0) {
